...
export function mapFirebaseAuthError(err: unknown): string {
  ...
  if (
    ...
    return (
      ...
      'your web API key/Identity Toolkit API key is restricted or the app origin is not authorized. ' +
      'Fix: Authentication → Settings → Authorized domains (add your Ionic URL/port) and ensure Identity Toolkit API is enabled in Google Cloud.'
    );
  }
  return msg;
}
