...
interface GroupOpt { id: number; name: string; is_active: boolean; }
  ...
  template: `
    <section class="drg">
      <header class="drg__head">
        ...
        <span class="drg__sub">Routes are granted by route groups — not the driver's vehicle.</span>
      </header>

      <div class="drg__body">
        <div class="drg__col">
          <div class="drg__label">Route groups</div>
          <div class="drg__empty" *ngIf="!groups.length">No route groups in this driver's city yet.</div>
