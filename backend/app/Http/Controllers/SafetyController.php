...
{
    public function trigger(Request $request, Trip $trip)
    {
        ...
        $isCustomer = $user->role === 'customer' && $trip->customer_id === $user->id;
        $isDriver = $user->role === 'driver' && $trip->driver_id === $user->id;
