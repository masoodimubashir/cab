...
3. **Phase 3 — Auto-refund rulebook + transfer reversal + held-earnings release** (`AutoRefundService`, `HeldEarningsService`). ~1–1.5 wks.
   ...
   - ⏳ **Remaining:** `refund.processed`/`refund.failed` webhook handling + sweeper retry of stuck/failed refunds (pairs with the deferred Phase 2 webhook work); Fixed/Shuttle seat-release refunds (R6/R7) fold in at Phase 5.
